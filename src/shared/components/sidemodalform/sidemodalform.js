        ...
        <div className="modal-body">
          ...
          >
            {({ isSubmitting, isValid }) => (
              <Form>
                <Input.FormGroup>
                  <Input.InputField id="Field 1" name="text" placeholder="Field 1" type="email" />
                </Input.FormGroup>

                <Input.FormGroup>
                  <Input.InputField id="Field 2" name="text" placeholder="Field 2" type="email" />
                </Input.FormGroup>
                <Input.FormGroup>
